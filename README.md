...
Semio Dsouza `<semiod@gmail.com>` 2026-05-30
...
* Section lines, which are horizontal bars of varying thickness above `H1`, `H2`, and `H3` headers. (See the [generated output](https://semiod.github.io/mdbook-template/) for an example of what these look like.)
...
[`https://semiod.github.io/mdbook-template/`](https://semiod.github.io/mdbook-template/) contains the output generated from this repo, as published by "`make gh-pages`" in the `Makefile`.
...
```
$ cd ~/git/
$ git clone https://github.com/semiod/mdbook-template newbook
$ cd newbook/
```
...
The template's `Makefile` is set up to use my [`git2rss`](https://github.com/semiod/git2rss) script to generate an RSS feed containing the commits in the repo's `main` branch.
...
For example, you can subscribe to [`https://semiod.github.io/mdbook-template/commits.xml`](https://semiod.github.io/mdbook-template/commits.xml) to watch for updates to the `semiod/mdbook-template` repo.
...
* If you use the [GitHub CLI](https://cli.github.com/) tool, you can create an empty repo with one command.
    ...
    ```
    $ gh repo create --public semiod/newbook
    ✓ Created repository semiod/newbook on GitHub
      https://github.com/semiod/newbook
    ```
    ...
    The last line of the output will be the HTTPS URL for the repo. If you use SSH to access remote repos, you may need to convert it. In this example, the SSH URL would be "`git@github.com:semiod/newbook`".
...
```
$ cd ~/git/newbook/
$ git remote add origin git@github.com:semiod/newbook
$ git push --all -u
$ git push --tags
```
...
If you're looking at the [generated HTML from this template repo](https://semiod.github.io/mdbook-template/), you will notice horizontal lines of different thickness above some of the section headers. The three example section headers will have the three "sizes" of lines.
...
If you're looking at the [generated HTML from this template repo](https://semiod.github.io/mdbook-template/), you will see a block at the bottom of the Table of Contents on the left, and a "footer" at the bottom of each main page, with information about the git commit containing the page's Markdown source.
